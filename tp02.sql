INSERT TO FOURNISSEUR(ID, NOM) VALUES (1, 'Française d''imports');
INSERT TO FOURNISSEUR(ID, NOM) VALUES (2,'FDM SA');
INSERT TO FOURNISSEUR(ID, NOM) VALUES (3,'Dubois & Fils');
...
INSERT TO ARTICLE(ID, REF, DESIGNATION, PRIX, ID_FOU) VALUES (5, 'A02', 'Meuleuse 125mm', 37.85, 1);
INSERT TO ARTICLE(ID, REF, DESIGNATION, PRIX, ID_FOU) VALUES (6, 'D03', 'Boulon acier zingué 4 x 40mm (sachet de 10)', 1.80, 3);
...
INSERT TO BON(ID, NUMERO, DATE_CMDE, DELAI, ID_FOU) VALUES (1, 1, CURRENT_TIMESTAMP, 15, 1);
INSERT TO BON(ID, NUMERO, DATE_CMDE, DELAI, ID_FOU) VALUES (2, 2, CURRENT_TIMESTAMP, 10, 2);
INSERT TO BON(ID, NUMERO, DATE_CMDE, DELAI, ID_FOU) VALUES (3, 3, CURRENT_TIMESTAMP, 5, 3);

INSERT TO COMPO(ID, QTE, ID_ART, ID_BON) VALUES (1, 10, 1, 1);
